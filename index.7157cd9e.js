...
var _setUpperCaseItemJs = require("./setUpperCaseItem.js");
var _setUpperCaseItemJsDefault = parcelHelpers.interopDefault(_setUpperCaseItemJs);
var _renderBooksJs = require("./renderBooks.js");
var _renderBooksJsDefault = parcelHelpers.interopDefault(_renderBooksJs);
var _clearFormsJs = require("./clearForms.js");
var _clearFormsJsDefault = parcelHelpers.interopDefault(_clearFormsJs);
var _createMessageJs = require("./createMessage.js");
var _createMessageJsDefault = parcelHelpers.interopDefault(_createMessageJs);
...
const setLibraryBooks = (library, book)=>{
    ...
    _renderBooksJsDefault.default(library, containerBooks);
};
btnSearch.addEventListener('click', function(e) {
    ...
    if (!storageLibraryBooks) return _createMessageJsDefault.default('Your Library is empty !!!', containerBooks);
    ...
    const booksFilter = lowerCaseLibrary.filter((book)=>book.title.includes(userTitle.toLowerCase()) && book.author.includes(userAuthor.toLowerCase())
    );
    _clearFormsJsDefault.default(inputTitle, inputAuthor);
    if (booksFilter.length === 0) return _createMessageJsDefault.default('No found book !', containerBooks);
    const booksUpperCase = _setUpperCaseItemJsDefault.default(booksFilter);
    _renderBooksJsDefault.default(booksUpperCase, containerBooks);
});
btnAddBook.addEventListener('click', function(e) {
    e.preventDefault();
    const library = [];
    if (inputTitle.value.length < 1 || inputAuthor.value.length < 3 || selectPriority.value === '' || selectCategory.value === '') return;
    containerBooks.textContent = '';
    const book = {
...
const init = ()=>{
    ...
    if (books === null) _createMessageJsDefault.default('Your Library is empty !!!', containerBooks);
    else _renderBooksJsDefault.default(JSON.parse(books), containerBooks);
};
init();

},{"./setUpperCaseItem.js":"954ER","./renderBooks.js":"9Xo3A","./clearForms.js":"12iLH","./createMessage.js":"hN9Ob","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"954ER":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
exports.default = upperCaseBooks;
...
},{}],"9Xo3A":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = renderBooks;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"12iLH":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
const clearValue = (inputTitle, inputAuthor)=>{
    inputTitle.value = '';
    inputAuthor.value = '';
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"hN9Ob":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["h10ks","bBdBR"], "bBdBR", "parcelRequireb7f1")
